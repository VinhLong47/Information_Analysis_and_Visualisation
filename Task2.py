...
plt.text(173, 85, s='Holborn', size=text_size)
...
line_legend = plt.legend(handles=line_labels, loc='lower right', title="Lines", fontsize=15, title_fontsize=15)
